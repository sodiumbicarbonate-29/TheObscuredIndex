...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Style for the plan to read section */
        .manhwa-card:has(.manhwa-genre + .reading-progress) .reading-status {
            width: 100%;
            text-align: right;
        }
        
        .manhwa-card:has(.manhwa-genre + .reading-progress) .read-btn {
            width: 100%;
            max-width: none;
        }
        ...
        /* Additional magical effects for buttons */
        .magic-btn {
            position: relative;
        }
        ...
        .magic-btn::after {
            ...
            bottom: -2px;
            border-radius: 22px;
            background: linear-gradient(45deg, #ff0080, #ff8c00, #ffff00, #00ff80, #00bfff, #8000ff, #ff0080);
        ...
        @keyframes sparkle {
            ...
            25% { opacity: 1; }
            100% { transform: translate(-25px, -25px) rotate(90deg); opacity: 0; }
        }
        
        /* Special styling for start button in plan to read section */
        .manhwa-card:has(.manhwa-genre + .reading-progress) .read-btn {
            width: 100%;
            background: linear-gradient(135deg, #b8a9f3, #7d71e4);
            box-shadow: 0 2px 10px rgba(162, 155, 254, 0.4);
        }
        
        .manhwa-card:has(.manhwa-genre + .reading-progress) .read-btn:hover {
            background: linear-gradient(135deg, #9f8df2, #6c5ce7);
            box-shadow: 0 5px 15px rgba(162, 155, 254, 0.6);
        }
...
<body>
    ...
    <main>
        ...
        <div class="main-content">
            ...
            <h1>Welcome back, <?php echo htmlspecialchars($username); ?>! <a href="secret-shelf_login.php" class="fairy-link">🧚‍♀️</a></h1>
            <p>
                            ...
                            <div class="reading-progress">
                                <div class="reading-status">
                                    <?php if (!empty($manhwa['reading_link'])): ?>
                                        <a href="<?php echo htmlspecialchars($manhwa['reading_link']); ?>" target="_blank" class="read-btn magic-btn"><i class="fas fa-book-open"></i> Read</a>
                                        <div class="status-tooltip">Still here? You're either REALLY into this… or just forgot it open.</div>
                                    <?php else: ?>
                                        <a href="view_manhwa.php?id=<?php echo $manhwa['manhwa_id']; ?>" class="read-btn magic-btn"><i class="fas fa-eye"></i> View</a>
                                        <div class="status-tooltip">Still here? You're either REALLY into this… or just forgot it open.</div>
                                    <?php endif; ?>
                                </div>
                                <div class="reading-status">
                                    <button class="done-btn magic-btn" onclick="updateReadingStatus('mark_done', <?php echo $manhwa['manhwa_id']; ?>)"><i class="fas fa-check"></i> Done</button>
                    ...
                    <div class="manhwa-card">
                        ...
                        <div class="manhwa-info">
                            ...
                            <div class="reading-progress">
                                <div class="reading-status">
                                    <?php if (!empty($manhwa['reading_link'])): ?>
                                        <a href="<?php echo htmlspecialchars($manhwa['reading_link']); ?>" target="_blank" class="read-btn magic-btn" onclick="updateReadingStatus('start_reading', <?php echo $manhwa['manhwa_id']; ?>)" style="width: 100%; max-width: none;"><i class="fas fa-book-open"></i> Start</a>
