...
// Get redirect destination (default to home.php)
    ...
    <style>
        ...
        * {
        ...
        .throne-base {
            ...
            overflow: hidden;
            animation: throne-glow 3s infinite alternate;
        }
        
        @keyframes throne-glow {
            0% { box-shadow: 0 0 20px rgba(142, 68, 173, 0.6); }
            100% { box-shadow: 0 0 30px rgba(142, 68, 173, 0.9), 0 0 50px rgba(142, 68, 173, 0.4); }
        }
    ...
    <script>
        ...
        function createMagicalRunes() {
            ...
            for (let i = 0; i < 20; i++) {
                ...
                // Position in a circle around the throne
                const angle = (i / 20) * Math.PI * 2; // Distribute evenly in a circle
                const radius = 120 + Math.random() * 30; // Vary the radius slightly
