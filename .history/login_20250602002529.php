...
<head>
    ...
    <style>
        :root {
            ...
            --light-color: #f5f6fa;
            --accent-color: #e84393;
            --fairytale-gold: #f1c40f;
            --fairytale-silver: #d1d1e0;
        }
        ...
        * {
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at center, transparent 0%, rgba(74, 35, 90, 0.4) 100%);
            pointer-events: none;
            z-index: -1;
        }
        ...
        .form-container {
            ...
            border-top: 2px solid var(--fairytale-silver);
            border-left: 2px solid var(--fairytale-silver);
        ...
        .form-container::before, .form-container::after {
            ...
            height: 40px;
            border-radius: 50%;
            background: radial-gradient(circle, var(--fairytale-gold) 0%, transparent 70%);
            filter: blur(5px);
            opacity: 0.6;
        ...
        .form-container:hover {
            ...
            border-top-color: var(--fairytale-gold);
            border-left-color: var(--fairytale-gold);
        }
    ...
    <main>
        <div class="container">
            <div class="form-container">
                ...
                <p class="fairytale-subtitle">Some just need their login details to read until 3 A.M.</p>
