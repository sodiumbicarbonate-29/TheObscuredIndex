...
<body>
    ...
    <main>
        <?php
        // Define quotes only once to be used for both slideshow and welcome message
        $morningQuotes = [
        ...
        if ($hour >= 5 && $hour < 12) {
            ...
            // For hours 12-17, we weren't setting any quotes
            $quotes = $morningQuotes; // Default to morning quotes for afternoon
