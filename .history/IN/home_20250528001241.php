                    ...
                    <div class="manhwa-card">
                        ...
                        <div class="manhwa-info">
                            ...
                            <div class="reading-progress">
                                ...
                                <button class="read-btn" style="background-color: var(--success-color);" onclick="updateReadingStatus('mark_done', <?php echo $manhwa['manhwa_id']; ?>)">Done</button>
                            </div>
                        </div>
                    </div>
                <?php endwhile; ?>
                ...
                <?php while ($manhwa = mysqli_fetch_assoc($plan_result)): ?>
                    <div class="manhwa-card">
                        ...
                        <div class="manhwa-info">
                            ...
                            <div class="reading-progress">
                                <?php if (!empty($manhwa['reading_link'])): ?>
                                    <a href="<?php echo htmlspecialchars($manhwa['reading_link']); ?>" target="_blank" class="read-btn" onclick="updateReadingStatus('start_reading', <?php echo $manhwa['manhwa_id']; ?>)">Read Now</a> 
                                <?php else: ?>
                                    <a href="view_manhwa.php?id=<?php echo $manhwa['manhwa_id']; ?>" class="read-btn">View</a>
                                <?php endif; ?>
                            </div>
