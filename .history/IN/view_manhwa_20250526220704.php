                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select id="genre" name="genre" class="form-control">
                                <option value="Action" <?php echo $manhwa['genre'] == 'Action' ? 'selected' : ''; ?>>Action</option>
                                <option value="Romance" <?php echo $manhwa['genre'] == 'Romance' ? 'selected' : ''; ?>>Romance</option>
                                <option value="Fantasy" <?php echo $manhwa['genre'] == 'Fantasy' ? 'selected' : ''; ?>>Fantasy</option>
                                <option value="Drama" <?php echo $manhwa['genre'] == 'Drama' ? 'selected' : ''; ?>>Drama</option>
                                <option value="Comedy" <?php echo $manhwa['genre'] == 'Comedy' ? 'selected' : ''; ?>>Comedy</option>
                            </select>
                        </div>
