...
$query = "SELECT * FROM Manhwas WHERE 1=1";
                ...
                <?php while ($manhwa = mysqli_fetch_assoc($result)): ?>
                    <div class="manhwa-card">
                        <div class="manhwa-cover">
                            <img src="<?php echo !empty($manhwa['covers']) ? '../' . htmlspecialchars($manhwa['covers']) : '../images/default-cover.jpg'; ?>" alt="<?php echo htmlspecialchars($manhwa['title']); ?>">
