        ...
        <div class="form-container">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="file" id="cover_image" name="cover_image" accept="image/jpeg,image/png,image/webp" style="display: none;">d="cover_preview" src="#" alt="Cover preview" style="display: none;">
                        <label for="cover_image" class="upload-btn">
                            <i class="fas fa-camera"></i>
                        </label>
                    </div>
