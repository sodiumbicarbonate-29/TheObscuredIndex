                    ...
                    <div class="manhwa-card">
                        ...
                        <div class="manhwa-info">
                            ...
                            <select class="reading-status-select" data-manhwa-id="<?php echo $manhwa['manhwa_id']; ?>">
                                ...
                                <option value="Done" <?php echo $manhwa['reading_status'] == 'Done' ? 'selected' : ''; ?>>Completed</option>
                                <option value="Dropped" <?php echo $manhwa['reading_status'] == 'Dropped' ? 'selected' : ''; ?>>Dropped</option>
                            </select>
