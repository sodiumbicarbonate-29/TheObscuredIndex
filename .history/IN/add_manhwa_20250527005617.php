...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error)) {
        ...
        mysqli_stmt_bind_param($stmt, "sssssss", $title, $author, $status, $genre, $description, $cover_image, $reading_link);
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            mysqli_stmt_bind_param($reading_stmt, "iisss", $user_id, $manhwa_id, $reading_status, $start_date, $finish_date);
...
<body>
    ...
    <script>
        ...
        // Show/hide date fields based on reading status
