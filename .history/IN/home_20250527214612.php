...
while ($genre_row = mysqli_fetch_assoc($genres_result)) {
    // Split comma-separated genres and add them individually
...
// Remove romance types that we'll add manually to prevent duplicates
...
sort($genres); // Sort alphabetically

// Remove romance types that we'll add manually
$romance_types = ['BL', 'Straight', 'No Romance'];
foreach ($romance_types as $type) {
    $key = array_search($type, $genres);
    if ($key !== false) {
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .stat-card {
            background: url('../images/stats-card.jpg') no-repeat center center;
        ...
        <div class="main-content">
            ...
            <div class="stats-container">
                <div class="stat-card">
                    ...
                    <p><i class="fas fa-book-open"></i> Reading</p>
                </div>
                <div class="stat-card">
                ...
                <div class="stat-card">
                    ...
                    <p><i class="fas fa-scroll"></i> Plan to Read</p>
                </div>
                <div class="stat-card">
                    <h3><?php echo $stats['total_count']; ?></h3>
                    <p><i class="fas fa-bookmark"></i> Total</p>
                </div>
            </div>
