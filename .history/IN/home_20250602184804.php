                    ...
                    <div class="manhwa-card">
                        ...
                        <div class="manhwa-info">
                            ...
                            <div class="reading-progress">
                                <div class="reading-status">
                                    <?php if (!empty($manhwa['reading_link'])): ?>
                                        <a href="<?php echo htmlspecialchars($manhwa['reading_link']); ?>" target="_blank" class="read-btn" onclick="updateReadingStatus('start_reading', <?php echo $manhwa['manhwa_id']; ?>)">Start</a>
