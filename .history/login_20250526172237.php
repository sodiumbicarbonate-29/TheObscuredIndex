...
<head>
    ...
    <style>
        ...
        * {
        ...
        #logo a:hover img {
            filter: drop-shadow(0 0 5px rgba(108, 92, 231, 0.6));
    ...
    <header>
        <div id="logo">
            <a href="index.php">
                ...
                <span style="color: var(--primary-color); font-size: 1.8rem; font-weight: bold; letter-spacing: 1px;">The Obscured Index</span>
            </a>
        </div>
