    ...
    <style>
        ...
        * {
        ...
        .slideshow-container {
            ...
            width: 100%;
            max-width: 100%;
            height: calc(100vh - 130px - 50px); /* Adjusted for header and footer */
            position: relative;
            overflow: hidden;
            z-index: 1;
            min-height: 400px;
...
<body>
    ...
    <main>
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
                <img src="images/index/3.jpg" alt="Featured Manhwa Collection">
            </div>
            
            <div class="mySlides fade">
                <img src="images/index/4.jpg" alt="Featured Manhwa Collection">
            </div>
            
            <div class="mySlides fade">
                <img src="images/index/5.jpg" alt="Featured Manhwa Collection">
            </div>
