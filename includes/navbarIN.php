...
<header>
    <div id="logo">
        <a href="<?php echo $home_path; ?>">
            <img src="<?php echo $logo_path; ?>" alt="The Obscured Index Logo">
        </a>
    </div>
    ...
    <nav id="navbar">
        <ul>
            ...
            <li><a href="<?php echo $library_path; ?>">Library</a></li>
...
<nav class="mobile-nav">
    <ul>
        <li><a href="<?php echo $home_path; ?>"><i class="fas fa-home"></i>Home</a></li>
        <li><a href="<?php echo $library_path; ?>"><i class="fas fa-book"></i>Library</a></li>
        <li><a href="<?php echo $add_path; ?>"><i class="fas fa-plus-circle"></i>Add</a></li>
        <li><a href="<?php echo $logout_path; ?>"><i class="fas fa-sign-out-alt"></i>Logout</a></li>
    </ul>
</nav>